  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \usepackage{fvextra}
        % fontsize=\scriptsize makes code very small to prevent wrapping
...
filename = "./enhanced_student_habits_performance_dataset.csv" 
...
Шугаман регресс нь өгөгдлийн олон шинжүүд болон зорилтот хувьсагчийн хоорондын шугаман хамаарлыг илэрхийлэх үндсэн арга юм. [@hastie2009elements]
...
Ridge Regression нь шугаман регрессийн өргөтгөл бөгөөд коэффициентуудын хэмжээг хэт их өсөхөөс хамгаалах L2-regularization ашигладаг. [@hoerl1970ridge]
...
Decision Tree Regressor нь өгөгдлийг дараалсан шийдвэрийн цэгүүдээр (splits) хувааж, шугаман бус хамаарлыг барьж чаддаг регрессийн загвар юм. [@breiman1984classification]
...
Random Forest Regressor нь олон шийдвэрийн модны ансамбль загвар бөгөөд overfitting–ийг бууруулж, тогтвортой таамаглал гаргах давуу талтай. [@breiman2001random]
...
-   Загвар оролтын өгөгдлийг өндөр хэмжээст орон зай руу kernel функцээр шилжүүлж, шугаман бус хамаарлыг илүү сайн барьдаг. [@drucker1997support]
...
K-Neighbors Regressor нь “ижил төстэй оюутнууд ижил төстэй оноо авдаг” гэсэн зарчимд тулгуурласан, энгийн бөгөөд интуитив регрессийн арга юм. Шинэ оюутны таамаглалыг хамгийн ойр K хөршийн дундаж оноогоор тооцдог. [@cover1967nearest]

**Алгоритмын үндсэн алхам**

1.  Шинэ оюутны шинжийг  өгөгдлийн орон зайд байрлуулна.
...
Gradient Boosting нь олон сул регрессийн модыг дараалан сургаж, өмнөх модны гаргасан алдааг нөхөн засах замаар нэг хүчтэй ансамбль загвар бий болгодог арга юм. [@friedman2001greedy]

Ерөнхий хэлбэр: $$ F_m(x) = F_{m-1}(x) + \nu \cdot h_m(x) $$

Энд:

-   $$F_m(x)$$ — m-р шатны нийлмэл модель

-   $$h_m(x)$$ — тухайн шатанд шинээр сурсан сул мод
...
```{python}
#| label: feature-importance-plots
#| echo: false
#| warning: false
#| message: false
#| fig-cap: "Feature Importance by Model"
#| fig-height: 10
#| fig-width: 12
...
for name, model in trained_models.items():
    ...
    if hasattr(model, 'feature_importances_'):
        ...
        imp = np.abs(model.coef_)
        if imp.ndim > 1: imp = imp[0]
    
    if imp is not None:
        plot_data.append((name, imp))
...
if n_plots > 0:
    ...
    for i, (name, imp) in enumerate(plot_data):
        df_imp = pd.DataFrame({
    ...
    print("Feature importance харуулах боломжтой загвар олдсонгүй.")
...
#| warning: false
#| message: false
#| fig-cap: "Actual vs Predicted Scores"
#| fig-height: 12
#| fig-width: 12
...
for i, (name, model) in enumerate(trained_models.items()):
    ...
    axes[i].scatter(y_test, y_pred, alpha=0.5, color='blue', edgecolor='k', s=20)
...
#| warning: false
#| message: false
#| fig-cap: "Confusion Matrices (Threshold = 60)"
#| fig-height: 12
#| fig-width: 12
...
Э.Доржням - Хэрэглэгчийн оруулсан өгөгдөл дээр үндэслэн шалгалтын оноог урьдчилан таамаглах(predictor.py)

А.Анударь - Регрессийн машин сургалтын моделуудыг сургах, үнэлэх(model_builder.py)
